...
public class ServletAppContext implements WebMvcConfigurer {
	...
	@Bean
	public MapperFactoryBean<TopMenuMapper> getTopMenuMapper1(SqlSessionFactory factory) throws Exception {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		/*
		 * java 설정 방식에서는 TopMenuInterceptor에서는, TopMenuService와 UserBean 객체가 자동으로 주입되지
		 * 않으므로 ServletAppContext 에서 TopMenuService와 UserBean 객체를 주입받아서
		 * ServletAppContext 에서 TopmenuInterceptor 객체를 생성할 때 TopMenuInterceptor의 생성자의
		 * argument로 topMenuService와 loginUserBean의 객체를 직접 넣어주어야 한다는 의미
		 */
	...
	// 에러 메시지를 작성한 properties 파일 등록하기
	@Bean
